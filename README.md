...
|6. [convert2pix.py](https://github.com/DDS-Lab/disaster-image-processing/blob/2022-update/scripts/utils/convert2pix.py)|8.b. [plot_bbox_uid_small.py](https://github.com/DDS-Lab/harvey_data_process/blob/master/plot_bbox_uid_small.py)|
