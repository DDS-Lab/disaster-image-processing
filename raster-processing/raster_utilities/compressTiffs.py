...
def compress_directory(directory_name, new_directory,
                       compression_method="JPEG", predictors=2):
    '''
    Compresses directory of TIFFs. Make sure script is ran from
    the parent directory that TIFFs are located in.
    ...
    :param new_directory_name: New directory for compressed TIFs
    ...
    for filename in os.listdir(directory_name):
        ...
        compress_tif(file, compression_method, predictors, new_directory)
...
if __name__ == "__main__":
    ...
    compress_directory(directory_name, new_directory)
